...
struct queue_from_stacks* queue_from_stacks_create() {
  struct queue_from_stacks* newQueuefromStacks = (struct queue_from_stacks*)malloc(sizeof(struct queue_from_stacks));
  newQueuefromStacks->s1 = stack_create();
  newQueuefromStacks->s2 = stack_create();
  return newQueuefromStacks;
}
